  ...
  return (
    <div className="flex-1 flex flex-col gap-3.5 text-slate-100 select-none">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-3 bg-slate-900/90 border border-slate-800 rounded-2xl shadow-inner">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 mt-1 flex-wrap">
              {chordNotesFormatted.map((n, idx) => (
                <span
                  key={idx}
                  className={`text-[10px] px-1.5 py-0.5 rounded-md font-mono font-bold border ${n.color}`}
                  title={n.role}
                >
                  {n.note} ({n.label})
                </span>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-1 bg-black/40 px-2 py-1 rounded-xl border border-slate-800 text-xs">
            <span className="text-[11px] text-slate-400 font-medium">Oktáva:</span>
            <button
          ...
          {/* Display Mode Toggle */}
          <div className="flex items-center bg-black/40 p-0.5 rounded-xl border border-slate-800 text-[11px]">
            <button
      ...
      <div className="bg-[#0b0f19] border border-slate-800 rounded-3xl p-4 sm:p-6 shadow-2xl flex flex-col items-center justify-center overflow-x-auto min-h-[220px] relative">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center gap-1">
                      {isChordNote && intervalInfo && (
                        <div
                          className={`w-6 h-6 rounded-full flex items-center justify-center font-mono font-black text-[10px] border shadow-md transition-transform group-hover:scale-110 ${intervalInfo.color}`}
                        >
                          {intervalInfo.label}
                        </div>
                      )}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center">
                      {isChordNote && intervalInfo && (
                        <div
                          className={`w-5 h-5 rounded-full flex items-center justify-center font-mono font-black text-[9px] border shadow-md transition-transform group-hover:scale-110 ${intervalInfo.color}`}
                        >
                          {intervalInfo.label}
                        </div>
                      )}
                    ...
                    {/* Bottom Note Name */}
                    <span className="font-mono text-[9px] font-bold text-center tracking-tighter">
        ...
        {/* Legend Footnote */}
        <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-[11px] text-slate-400 border-t border-slate-800/80 pt-3 w-full">
