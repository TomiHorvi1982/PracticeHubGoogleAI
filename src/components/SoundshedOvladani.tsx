      ...
      {!midi.pripojeno ? (
        ...
        <div className="flex flex-wrap items-center gap-2">
          <select
            ...
            className="bg-black/30 border border-white/[0.08] rounded-lg px-2 py-1.5 text-drobne text-white focus:outline-none focus:border-white/25"
          >
          ...
          <label className="text-stitek text-neutral-500 flex items-center gap-1">
            ...
            <input
              ...
              className="w-12 bg-black/30 border border-white/[0.08] rounded-lg px-1.5 py-1 text-drobne text-white focus:outline-none focus:border-white/25"
            />
          </label>
        </div>
      )}
