  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-md flex items-center justify-center p-4 font-sans">
      <div className="bg-plocha-2 border border-white/[0.1] w-full max-w-xl p-6 rounded-3xl shadow-2xl text-white relative">
        ...
        <button
          onClick={onClose}
          className="absolute top-5 right-5 text-pismo-tlum hover:text-white p-2 hover:bg-white/10 rounded-xl transition-all cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        {!importResult ? (
          ...
          >
            ...
            {isProcessing ? (
              ...
              <div className="flex flex-col items-center gap-3">
                <div className="flex items-center justify-center gap-3 text-pismo-tlum">
          ...
          <div className="space-y-4 bg-black/40 p-5 rounded-2xl border border-white/10">
            <div className="flex items-center justify-between border-b border-white/5 pb-3">
              ...
              <span className="odznak bg-white/10 text-pismo px-2.5 py-0.5 rounded-md font-mono">
            ...
            <div className="grid grid-cols-2 gap-3.5 text-xs">
              <div className="space-y-1">
                <label className="text-xs font-semibold text-pismo-tlum">Název skladby</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-xs font-semibold text-pismo-tlum">Interpret / Autor</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-xs font-semibold text-pismo-tlum">Tónina (Key)</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-xs font-semibold text-pismo-tlum">Tempo (BPM)</label>
                <input
                  type="number"
            ...
            {/* File info badge */}
            <div className="bg-white/5 p-3 rounded-xl border border-white/5 text-xs text-pismo flex items-center justify-between">
              <div>
                <span className="font-semibold text-white">{importResult.attachment.name}</span>
                <span className="text-drobne text-pismo-tlum ml-2">
            ...
            <div className="flex gap-2.5 pt-2">
              <button
                ...
                className="flex-1 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 text-pismo hover:text-white text-xs font-semibold rounded-xl transition-all cursor-pointer"
              >
                Vybrat jiný soubor
              </button>
              <button
        ...
        {errorMessage && (
          <div className="mt-4 p-3 bg-chyba/10 border border-chyba/30 rounded-2xl text-xs text-chyba-svetla flex items-center gap-2">
