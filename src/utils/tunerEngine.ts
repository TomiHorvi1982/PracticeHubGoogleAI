...
/**
 * Přečte klíč z úložiště, a když chybí, zkusí starší názvy. Převzato z
 * `storageMigration` v MoChordu — engine ho používá na jediném místě, takže
 * se sem vešlo místo tažení celého jejich modulu.
 */
function getMigratedStorageItem(
  ...
  for (const legacyKey of legacyKeys) {
    ...
    try {
      ...
      /* plné úložiště — hodnotu stejně vracíme */
    }
    return legacy;
  }
  return null;
